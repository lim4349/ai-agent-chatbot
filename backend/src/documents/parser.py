...
class DocumentParser:
    ...
    def _parse_text_content(self, text: str) -> list[DocumentSection]:
        ...
        return [
            DocumentSection(content=para, section_type="paragraph")
    ...
    def _parse_pdf(self, path: Path) -> list[DocumentSection]:
        ...
        try:
            ...
            raise ImportError("pdfplumber is required for PDF parsing. Install with: pip install pdfplumber") from err
    ...
    def _parse_docx(self, path: Path) -> list[DocumentSection]:
        ...
        try:
            ...
            raise ImportError("python-docx is required for DOCX parsing. Install with: pip install python-docx") from err
    ...
    def _extract_json_text(self, data: object, sections: list[DocumentSection], prefix: str = "") -> None:
